                    ...
                    <div class="col-11 my-4 shadow rounded">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="col-12 d-flex">
                                <div class="col-3">
                                    <input type="text" class="col-12 rounded px-3 py-2 border border-secondary mx-5" placeholder="Home work" name="title" value="<?php echo $row["title_db"]?>">
                                </div>
                                ...
                                <div class="col-3">
                                    <input type="date" class="col-12 rounded px-3 py-2 border border-secondary mx-5" name="expire-date" value="<?php echo $row["expire_date_db"]?>" min=<?php echo date("Y-m-d")?>>
                                </div>
                            </div> 
                            <div class="col-12">
                                <textarea name="description"  class="col-10 rounded mt-2 mx-5 px-3" placeholder="Type description..."><?php echo $row["description_db"]?></textarea>
                            </div>
